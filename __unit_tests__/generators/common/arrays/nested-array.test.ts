...
describe('nested array', () => {
  ...
  it('should throw on missing definition', () => {
    expect(() => nestedArrayGenerator({
      ecosystem,
      minItems: 2,
      maxItems: 5,
    })).toThrow(`Can't generate a nested array - 'definition' is a required property`);
  });
  ...
  it('should throw on missing maxItems property', () => {
    expect(() => nestedArrayGenerator({
      ...
      definition,
      minItems: 2,
    })).toThrow(`Can't generate a nested array - 'maxItems' is a required property`);
  });
  ...
  it('should throw on minItems > maxItems', () => {
    expect(() => nestedArrayGenerator({
      ...
      minItems: 2,
      maxItems: 1,
    })).toThrow(`Can't generate a nested array - 'minItems' must be less or equal to 'maxItems' (2 > 1)`);
  });
  ...
  it('should throw on minItems is negative', () => {
    expect(() => nestedArrayGenerator({
      ...
      minItems: -2,
      maxItems: 1,
    })).toThrow(`Can't generate a nested array - both 'minItems' and 'maxItems' must be positive numbers`);
  });
