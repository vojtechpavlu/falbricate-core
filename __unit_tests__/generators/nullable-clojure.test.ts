...
describe('Nullability clojure', () => {
  it('should return a Value generator (function)', () => {
    ...
    const nullableGenerator = nullabilityClojure(randomizer, generator, 0.5);
  ...
  it('should return value generator returning the expected non-null value when P=0', () => {
    ...
    const nullableGenerator = nullabilityClojure(randomizer, generator, 0);
  ...
  it('should return value generator returning the expected null-like value when P=1', () => {
    ...
    const nullableGenerator = nullabilityClojure(randomizer, generator, 1);
  ...
  it('should throw on probability out of range', () => {
    ...
    expect(() => nullabilityClojure(randomizer, generator, 100)).toThrow(
  ...
  it('should throw on undefined probability', () => {
    ...
    expect(() => nullabilityClojure(randomizer, generator, undefined)) // eslint-disable-line unicorn/no-useless-undefined
